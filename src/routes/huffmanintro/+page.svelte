...
<div class="digital-container">
  <div class="digital-text">
      ...
      <pre>{text}</pre>
      <button class="button" onclick="window.location.href='/HuffmanViz/main'" style="margin-left: 340px;">Try it for yourself</button> <!-- Adjust margin-left to shift the button -->
  </div>
