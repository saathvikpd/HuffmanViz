<script>
    ...
    switch (currentStep) {
        case 1:
            ...
            if (!nodeA) {
                console.log("Priority queue is empty or does not contain enough elements. Unable to proceed.");
                return;
            }
            console.log(nodeA);
        ...
        case 2:
            ...
            if (!nodeB) {
                console.log("Priority queue does not contain enough elements. Unable to proceed.");
                return;
            }
            console.log(nodeB);
