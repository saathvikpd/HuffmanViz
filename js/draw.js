...
<<<<<<< HEAD
    ...
    var displayText = "Your text: " + txt +
    "\nHuffman Encoding for input text: " + encodedText +
    "\nSpace Saved: " + spaceSavedPercentage + "%";

// Create a new <p> element to hold the text
var encodedTextElement = document.createElement("p");

// Set the text content of the <p> element
encodedTextElement.textContent = displayText;

// Find the element with id "encoded-text" and append the new <p> element as its child
